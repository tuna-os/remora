...
func cmdInit(dir string) error {
	...
	if err := buildplan.Regenerate(dir, m, false); err != nil {
		return err
	}
...
func cmdModify(dir string, add, remove []string, noBuild bool) error {
	...
	if err := buildplan.Regenerate(dir, m, !noBuild); err != nil {
		return err
	}
	if noBuild {
...
func cmdBuild(dir string, build bool) error {
	...
	if err := buildplan.Regenerate(dir, m, build); err != nil {
		return err
	}
	if !build {
		return nil
...
func cmdUpgrade(dir string, noBuild bool) error {
	...
	old, err := buildplan.ResolveBase(dir, m)
	if err != nil {
		return err
	}
	...
	if err := buildplan.Regenerate(dir, m, true); err != nil {
		return err
	}
	if noBuild {
		return nil
